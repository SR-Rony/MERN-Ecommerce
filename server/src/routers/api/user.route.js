...
const { getUsers, getSingleUser, deleteUser, register, userVerify, updateUser, bannedUser } = require("../../controller/user.controller")
...
// banned user
route.put("/ban-user/:id",isLoggedIn,isAdmin,bannedUser)
